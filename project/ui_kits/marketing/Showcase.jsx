  ...
  <section style={{ padding: "80px 32px", background: "var(--n-10)" }}>
    <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48, alignItems: "center" }}>
      <div>
        ...
        <h2 style={{ font: "600 36px/110% var(--font-sans)", letterSpacing: "-0.02em", margin: "10px 0 14px" }}>Находки — прямо в тексте документа.</h2>
        ...
        <ul style={{ paddingLeft: 0, listStyle: "none", marginTop: 20, display: "flex", flexDirection: "column", gap: 10 }}>
          {["Подсветка рисков с уровнем уверенности","Diff с вашим плейбуком — в один клик","Контрформулировка в буфер или в письмо одной кнопкой"].map(t => (
      ...
      <div className="card" style={{ padding: 22 }}>
        ...
        <div style={{ marginTop: 14, padding: "10px 12px", borderRadius: 10, background: "#FCE4E8", display: "flex", gap: 10 }}>
          <svg width={18} height={18} viewBox="0 0 24 24" fill="none" stroke="#B00020" strokeWidth={1.6}><circle cx="12" cy="12" r="9"/><path d="M12 8v4"/></svg>
          <div style={{ flex: 1 }}>
