const Footer = () => (
  <footer style={{ background: "#0A0A12", color: "rgba(255,255,255,0.7)", padding: "56px 32px 28px" }}>
    <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", gap: 32 }}>
      <div>
        <img src="../../assets/lexara-wordmark-inverse.svg" height={32} alt="Lexara" />
      ...
      {[
        ...
        <div key={col.t}>
          ...
          <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 8 }}>
            {col.l.map(l => <li key={l}><a href="#" style={{ color: "rgba(255,255,255,0.7)", textDecoration: "none", font: "400 14px/20px var(--font-sans)" }}>{l}</a></li>)}
          </ul>
        </div>
      ))}
    </div>
    <div style={{ maxWidth: 1100, margin: "32px auto 0", paddingTop: 20, borderTop: "1px solid rgba(255,255,255,0.08)",
      display: "flex", justifyContent: "space-between", font: "400 12px/16px var(--font-mono)", color: "rgba(255,255,255,0.5)" }}>
