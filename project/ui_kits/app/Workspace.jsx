// Workspace — contract list with filters + summary.
const CONTRACTS = [
      ...
      <Card padding={0} style={{ overflow: "hidden" }}>
        ...
        {list.map((c, i) => (
          ...
          >
            ...
            <div style={{ color: "var(--fg-3)", display: "flex", justifyContent: "flex-end" }}><Icon name="more" size={16} /></div>
          </div>
        ))}
      </Card>
    </div>
