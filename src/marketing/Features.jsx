const FEATURES = [
  ...
  {
    t: 'Отмечает',
    icon: 'M12 3l8 4v5c0 5-3.5 8-8 9-4.5-1-8-4-8-9V7z|M12 9v4|M12 16h0',
    b: 'Каждая нетипичная формулировка получает находку — с уверенностью, ссылкой на источник и сравнением с похожими договорами.',
  },
  {
    t: 'Готовит стратегию',
    icon: 'M12 3l1.5 4.5L18 9l-4.5 1.5L12 15l-1.5-4.5L6 9l4.5-1.5z|M19 14l.7 2.1L22 17l-2.3.9L19 20l-.7-2.1L16 17l2.3-.9z',
  ...
  return (
    <section style={{ padding: '80px 32px', maxWidth: 1200, margin: '0 auto' }}>
      <div style={{ textAlign: 'center', marginBottom: 48 }}>
        ...
        <h2 style={{ font: '600 40px/100% var(--font-sans)', letterSpacing: '-0.02em', margin: '10px 0' }}>
          От загрузки до подписи — за дни, не недели.
        </h2>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 16 }}>
        {FEATURES.map((f, i) => (
          <div key={i} style={{ background: 'white', borderRadius: 16, border: '1px solid var(--border)', boxShadow: 'var(--shadow-sm)', padding: 24 }}>
            <div style={{ width: 44, height: 44, borderRadius: 12, background: 'var(--brand-soft)', color: 'var(--brand)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 16 }}>
