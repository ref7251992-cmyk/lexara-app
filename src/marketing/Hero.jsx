  ...
  return (
    <section style={{
      ...
      <div style={{ maxWidth: 880, margin: '0 auto' }}>
        ...
        <h1 style={{
          font: '700 60px/100% var(--font-sans)',
      ...
      <div style={{ maxWidth: 1080, margin: '56px auto 0', background: 'white', borderRadius: 16, border: '1px solid var(--border)', boxShadow: 'var(--shadow-sm)' }}>
        <div style={{ height: 64, display: 'flex', alignItems: 'center', padding: '0 16px', borderBottom: '1px solid var(--divider)' }}>
          ...
          <div style={{ flex: 1, textAlign: 'center', font: '500 13px/18px var(--font-mono)', color: 'var(--fg-3)' }}>
            app.lexara.ai · рабочее пространство
          </div>
        </div>
        <div style={{ height: 360, padding: 24, background: 'var(--n-10)', borderRadius: '0 0 16px 16px' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '240px 1fr', gap: 20, height: '100%' }}>
            <div style={{ background: 'white', borderRadius: 12, border: '1px solid var(--border)', boxShadow: 'var(--shadow-sm)', padding: 14 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              {[
                ...
                <div key={i} style={{ background: 'white', borderRadius: 12, border: '1px solid var(--border)', boxShadow: 'var(--shadow-sm)', display: 'flex', alignItems: 'center', gap: 14, padding: 14 }}>
                  <div style={{ width: 36, height: 36, borderRadius: 8, background: 'var(--n-20)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--fg-2)' }}>
                  ...
                  <span style={{
                    ...
                    {r.tone === 'danger' ? 'Высокий риск' : r.tone === 'warning' ? 'Проверка' : 'Переговоры'}
                  </span>
                </div>
              ))}
            </div>
